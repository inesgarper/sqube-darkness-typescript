class Cube {
    ...
    private imageInstanceJumpingRight: any
    private imageInstanceLeft: any
    private imageInstanceJumpingLeft: any
    ...
    draw(): void {
        ...
        if (this.isJumping || this.isJumping && this.isFacingRight) this.imageSrc = this.imageInstanceJumpingRight
        if (this.isJumping || this.isJumping && this.isFacingLeft) this.imageSrc = this.imageInstanceJumpingLeft
